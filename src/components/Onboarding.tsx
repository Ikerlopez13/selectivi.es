...
const slides: Slide[] = [
  {
    ...
    alt: "Slide 1 - Aquí es donde estás ahora",
  },
  {
    kind: "image",
    src: "/images/slide2.png",
    alt: "Slide 2 - Aquí es donde puedes llegar",
  },
...
export default function Onboarding() {
  ...
  const Card = ({ children }: { children: React.ReactNode }) => (
    <div className="mx-auto w-full px-1 sm:px-2 max-w-[360px] sm:max-w-[400px] md:max-w-[420px]">
      <div className="relative flex flex-col items-center">
        ...
        <div className="pt-10 rounded-2xl bg-white border border-black/5 shadow-xl overflow-hidden min-h-[500px] sm:min-h-[540px] md:min-h-[620px] flex flex-col">
          {children}
        </div>
      </div>
    </div>
  ...
  const renderSlide = (s: Slide, i: number) => {
    if (s.kind === "image") {
      return (
        <Card>
          <div className="px-4 sm:px-6 pb-8 flex flex-col h-full">
            <div
              className={`flex items-center justify-center mt-2 mb-4 ${
                i === 1
                  ? "h-[200px] sm:h-[220px] md:h-[280px]"
            ...
            >
              <Image
                ...
                height={200}
                className={`${
                  i === 1 ? "max-h-[180px] sm:max-h-[200px]" : "max-h-full"
                } w-auto`}
                priority={i === index}
              />
            </div>
            {i === 0 ? (
              <>
                ...
                <h3 className="text-[22px] font-extrabold text-center mb-3 underline decoration-2 underline-offset-4">
                  Aquí es donde estás ahora
                </h3>
                <p className="text-center text-gray-500 font-extrabold mb-3 text-[22px] leading-7">
                  {"¿Aún dudas de si conseguirás"}
                  <br />
                  {"la uni que sueñas?"}
                </p>
                <p className="text-gray-700 text-center whitespace-pre-line text-[16px] sm:text-[17px] leading-6">
                  {
              ...
              <>
                ...
                <h3 className="text-lg font-bold text-center mb-3 underline decoration-2 underline-offset-4 text-gray-900">
                  Aquí es donde puedes llegar
                </h3>
                <div className="w-full mb-3 text-center">
                  <p className="max-w-[280px] mx-auto text-center text-gray-900 font-semibold text-[16px] sm:text-[17px] leading-tight">
                    Con Seletest, podrás convertirte en
                    <br />
                    <span className="font-bold bg-[#FFF3C4]/80 rounded px-1">
                      ese estudiante
                    </span>{" "}
                    que entra a la
                    <br />
                    <span className="font-bold underline decoration-[3px] underline-offset-4">
                      universidad que quiere.
                    </span>
                  </p>
                </div>
                <p className="text-gray-600 text-center text-[12px] leading-relaxed mb-4">
                  Solo 10-20 minutos al día… test simples,
                  <br className="hidden sm:block" />
                  memorizables y acompañamiento hasta el final.
                </p>
                <div className="flex flex-col items-center gap-2 mb-4">
                  <span className="w-full max-w-[280px] mx-auto inline-flex items-center justify-center gap-2 bg-[#F4F5F7] rounded-full px-3 py-2 text-[12px] text-gray-800 shadow-sm">
                    <span className="text-green-600">✓</span> Miles de preguntas
                    reales de EvAU.
                  </span>
                  <span className="w-full max-w-[280px] mx-auto inline-flex items-center justify-center gap-2 bg-[#F4F5F7] rounded-full px-3 py-2 text-[12px] text-gray-800 shadow-sm">
                    <span className="text-green-600">✓</span> Bachillerato, no
                    solo la Selectividad.
                  </span>
                  <span className="w-full max-w-[280px] mx-auto inline-flex items-center justify-center gap-2 bg-[#F4F5F7] rounded-full px-3 py-2 text-[12px] text-gray-800 shadow-sm">
    ...
    if (s.kind === "content" && s.id === "duolingo") {
      return (
        <Card>
          <div className="px-6 pb-8 text-center flex flex-col h-full">
            <div className="relative mx-auto bg-gradient-to-r from-[#FFD775] to-[#FFE79A] text-black rounded-3xl px-6 py-6 md:px-8 md:py-8 font-semibold italic mb-5 shadow-xl ring-1 ring-[#DFAA00]/30">
              <p className="text-[18px] md:text-[20px] leading-snug">
                “Es el Duolingo de la EvAU…
                <br className="hidden md:block" /> pero para Bachillerato y
                Selectividad.”
              </p>
            </div>
            <div className="mx-auto mb-4 w-fit text-[12px] bg-[#FFF3C4] rounded-full px-3 py-1 text-black/70">
            ...
            <div className="mx-auto max-w-[320px]">
              <h3 className="text-[22px] font-extrabold mb-3 leading-7">
                {"Cada test es un paso hacia"}
                <br />
                {"tu plaza universitaria."}
              </h3>
    ...
    if (s.kind === "content" && s.id === "claro") {
      return (
        <Card>
          <div className="px-4 sm:px-6 pb-8 flex flex-col h-full">
            <ul className="space-y-2 text-[16px] sm:text-[18px] mx-auto max-w-[320px] mt-24 sm:mt-32 md:mt-40 text-left">
              <li>
                El sueño está claro; <strong>tu universidad</strong>.
              </li>
              <li>
                La probabilidad, <strong>muy alta con seleTest</strong>.
              </li>
              <li>
                El tiempo: <strong>solo minutos al día</strong>.
              </li>
              <li>
                El esfuerzo: mínimo,{" "}
        ...
        <div className="px-4 sm:px-6 pb-8 text-center flex flex-col h-full">
          ...
          <div className="mx-auto max-w-[320px] text-left">
            <p className="text-gray-800 font-semibold mb-2">
              Pero aquí está la razón:
            </p>
            <p className="text-gray-700 mb-3">
              te damos <u>todo lo que necesitas</u> para
              <br className="hidden md:block" />
              estudiar <u>sin perder tiempo ni energía</u>.
            </p>
            <p className="text-gray-800 font-semibold mb-2">
              Y por qué es justo:
            </p>
  ...
  return (
    <section
      id="onboarding"
      className="relative flex items-stretch py-12 md:py-16"
    >
      <div className="relative max-w-[1100px] mx-auto px-4 sm:px-6 w-full">
        <h2 className="text-center mb-6 md:mb-8">
          <span className="inline-flex items-center gap-2 bg-white/80 backdrop-blur rounded-full px-4 py-2 text-xs sm:text-sm md:text-base font-semibold text-black/80 shadow-sm ring-1 ring-black/5">
            Descubre cómo funciona en{" "}
            <span className="font-extrabold text-black">60 segundos</span>
          </span>
        </h2>
        <div
        ...
        >
          ...
          >
            {slides.map((s, i) => {
              ...
              return (
                <div
                  key={i}
                  className={`w-full shrink-0 px-3 sm:px-6 py-8 sm:py-10 md:px-12 transition-opacity duration-300 ${
                ...
                >
                  {s.kind === "image" ? (
                    <Card>
                      <div className="px-4 sm:px-6 pb-8 flex flex-col h-full">
                        <div
                          className={`flex items-center justify-center mt-2 mb-4 ${i === 1 ? "h-[200px] sm:h-[220px] md:h-[280px]" : "h-[220px] sm:h-[260px] md:h-[340px]"}`}
                        >
                          <Image
                            src={s.src}
                            alt={s.alt}
                            width={400}
                            height={200}
                            className={`${i === 1 ? "max-h-[180px] sm:max-h-[200px]" : "max-h-full"} w-auto`}
                            priority={i === index}
                          />
                        </div>
                        {i === 0 ? (
                          ...
                          <>
                            <div className="mx-auto mb-3 w-fit text-[12px] font-medium bg-[#FFF3C4] rounded-full px-3 py-1 text-orange-600">
                              ✨ el 87% de la promoción anterior entró en su
                              primera opción
                            </div>
                            <h3 className="text-lg font-bold text-center mb-3 underline decoration-2 underline-offset-4 text-gray-900">
                              Aquí es donde puedes llegar
                            ...
                            <div className="flex flex-col items-center gap-2 mb-4">
                              <span className="w-full max-w-[280px] mx-auto inline-flex items-center justify-center gap-2 bg-[#F4F5F7] rounded-full px-3 py-2 text-[12px] text-gray-800 shadow-sm">
                                <span className="text-green-600">✓</span> Miles
                                de preguntas reales de EvAU.
                              </span>
                              <span className="w-full max-w-[280px] mx-auto inline-flex items-center justify-center gap-2 bg-[#F4F5F7] rounded-full px-3 py-2 text-[12px] text-gray-800 shadow-sm">
                                <span className="text-green-600">✓</span>{" "}
                                Bachillerato, no solo la Selectividad.
                              </span>
                              <span className="w-full max-w-[280px] mx-auto inline-flex items-center justify-center gap-2 bg-[#F4F5F7] rounded-full px-3 py-2 text-[12px] text-gray-800 shadow-sm">
                                <span className="text-green-600">✓</span>{" "}
                    ...
                    <Card>
                      <div className="px-6 pb-8 text-center flex flex-col h-full">
                        <div className="relative mx-auto bg-gradient-to-r from-[#FFD775] to-[#FFE79A] text-black rounded-3xl px-6 py-6 md:px-8 md:py-8 font-semibold italic mb-5 shadow-xl ring-1 ring-[#DFAA00]/30">
                          <p className="text-[18px] md:text-[20px] leading-snug">
                            “Es el Duolingo de la EvAU…
                            <br className="hidden md:block" /> pero para
                            Bachillerato y Selectividad.”
                          </p>
                        </div>
                        <div className="mx-auto mb-4 w-fit text-[12px] bg-[#FFF3C4] rounded-full px-3 py-1 text-black/70">
                          ✨ el 87% de la promoción anterior entró en su primera
                          opción
                        </div>
                        <div className="mx-auto max-w-[320px]">
                          <h3 className="text-[22px] font-extrabold mb-3 leading-7">
                          ...
                          <p className="text-gray-700">
                            Sin complicaciones, sin agobios.
                          </p>
                        </div>
                        <div className="mt-auto pt-6">
                          <a
                    ...
                    <Card>
                      <div className="px-4 sm:px-6 pb-8 flex flex-col h-full">
                        <ul className="space-y-2 text-[16px] sm:text-[18px] mx-auto max-w-[320px] mt-24 sm:mt-32 md:mt-40 text-left">
                          ...
                          <li>
                            La probabilidad,{" "}
                            <strong>muy alta con seleTest</strong>.
                          </li>
                          <li>
                            El tiempo: <strong>solo minutos al día</strong>.
                          </li>
                    ...
                    <Card>
                      <div className="px-4 sm:px-6 pb-8 text-center flex flex-col h-full">
                        ...
                        <p className="italic text-gray-700 mb-6">
                          Este es un{" "}
                          <span className="italic">recurso de pago</span>
                        </p>
                        <div className="mx-auto max-w-[320px] text-left">
                          <p className="text-gray-800 font-semibold mb-2">
                            Pero aquí está la razón:
          ...
          <div className="sm:hidden flex justify-between px-2 pt-3">
            <button
              aria-label="Anterior"
              onClick={prev}
              disabled={index === 0}
