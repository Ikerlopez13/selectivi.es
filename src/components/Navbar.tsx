    ...
    supabase.auth.getSession().then(async ({ data }) => {
      ...
      if (userId) {
        ...
        try {
          ...
          if (!existing && !selErr) {
            ...
            const name =
              ...
              email.split("@")[0] ||
              "Usuario";
            const inferredCommunity = location.pathname.startsWith("/madrid")
              ? "madrid"
              : "desconocida";
        ...
        if (email) {
          ...
          try {
            localStorage.setItem("es_premium", isPremium ? "1" : "0");
          } catch {}
        }
      } else {
                ...
                onClick={() => {
                  if (!hasSession) {
                    window.location.href =
                      "/madrid/login?next=/madrid/dashboard";
                  } else {
                ...
                <button
                  onClick={() => {
                    if (!hasSession)
                      window.location.href =
                        "/madrid/login?next=/madrid/dashboard";
                    else window.location.href = "/madrid/seletest";
                  }}
